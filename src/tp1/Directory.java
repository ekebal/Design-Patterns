...
{
	private Collection<ElementStockage> listeDossier ; // collection des lments de stockage que le dossier contient
...
//		Iterator<ElementStockage> it = this.listeDossier.iterator();
//		
//		while (it.hasNext())
//		{
//			ElementStockage f = it.next();
//			
//			f.accept(v);
//		}
		for (ElementStockage f : this.listeDossier)
		{
			f.accept(v);
		}
